...
class VillageType extends Common {
    ...
    public static function onBeforeInsert(Model $model) {
        $uniqid = strtoupper(uniqid('village-type-'));
    ...
    public static function getList($where = array()) {
        return VillageType::withoutField('delete_time')
    ...
    public static function getAll($where = array()) {
        return VillageType::withoutField('delete_time')
            ->field('uniqid,name,sign,sort,remark')
            ->where('lang',input('get.lang', config('lang.default_lang')))
    ...
    public static function getFind($where = array()) {
        $data = VillageType::withTrashed()->field('uniqid,name,sign,sort,remark')
            ->where('lang',input('get.lang', config('lang.default_lang')))
            ->where($where)->find();
